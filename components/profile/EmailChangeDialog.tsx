...
export function EmailChangeDialog({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-end justify-center bg-ink/60 p-4 backdrop-blur sm:items-center"
      onClick={onClose}
    >
      <div
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h2 id="email-dialog-title" className="text-lg font-black">
              Mudar email
            </h2>
        ...
        {success ? (
          ...
          <form onSubmit={submit} className="mt-4 space-y-3">
            <label className="block text-xs font-bold uppercase tracking-wider text-ink/55">
              Novo email
            </label>
            <input
              type="email"
              ...
              className="w-full rounded-2xl border-2 border-cloud-deep px-3 py-2.5 text-sm font-bold outline-none ring-sky focus:border-sky focus:ring-2"
              autoFocus
            />
            {error && (
